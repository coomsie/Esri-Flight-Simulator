...
function (
    ...
    $(document).ready(function () {
        ...
        esriConfig.request.corsEnabledServers.push("gisbasemap.ecan.govt.nz");
  
        var mapBaseLayer = new TileLayer({
            url: "//gisbasemap.ecan.govt.nz/arcgis/rest/services/Imagery/Imagery_basemap_WGS84_4/MapServer"
        });
        // Create a Basemap with the WebTileLayer. The thumbnailUrl will be used for
        // the image in the BasemapToggle widget.
        var ecan = new Basemap({
            baseLayers: [ mapBaseLayer ],
            title: "ECan Imagery",
            id: "ecanImagery",
            thumbnailUrl: "//www.arcgis.com/sharing/rest/content/items/17ea68e0628140da919d16e49e878e79/info/thumbnail/Latest_Imagery_with_labels.png"
        });



        var myheading=310;
        var myheadingleft=myheading-270;
        var myheadingright=myheading-90;
        ...
        var map = new WebMap({
                portalItem: {
                    id: '3cfca7247e814268ba9c3c5bd00a6053'
                },
            basemap: ecan,
            ground: "world-elevation"
        });
        ...
        //     url: "//gis.ecan.govt.nz/arcgis/rest/services/Public/Public_Access_Sites/MapServer/1"
        //   });
        ...
        viewForward.when(function() {
            ...
            viewForward.ui.add(legend, "bottom-left");
        ...
        viewForward.ui.add(toggle, "top-right");
        });
       ...
       window.requestAnimationFrame(draw);
        ...
        function draw(time) {
            if (map.ground.loaded && lastTime !== null) {
